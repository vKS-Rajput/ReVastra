    ...
    <div className="bg-gradient-to-b from-white to-gray-50 py-12 px-4 sm:px-8">
      ...
      <div className="my-10 flex flex-col lg:flex-row gap-16 lg:px-16">
        ...
        <div className="flex flex-col justify-center items-start gap-8 lg:w-2/4">
          <h3 className="text-xl font-semibold text-gray-800 mb-4">Reach Out to Us</h3>
          ...
          <div className="space-y-6">
            <div className="flex items-center gap-4 bg-gradient-to-r from-blue-100 to-blue-50 p-5 rounded-lg shadow-md hover:shadow-xl transition-shadow">
              <FaMapMarkerAlt className="text-blue-600 text-2xl" />
              <span className="text-gray-700 font-medium">1234 Street Name, City, State, 12345</span>
            </div>
            <div className="flex items-center gap-4 bg-gradient-to-r from-green-100 to-green-50 p-5 rounded-lg shadow-md hover:shadow-xl transition-shadow">
              <FaPhoneAlt className="text-green-600 text-2xl" />
              <span className="text-gray-700 font-medium">+1 (234) 567-890</span>
            </div>
            <div className="flex items-center gap-4 bg-gradient-to-r from-pink-100 to-pink-50 p-5 rounded-lg shadow-md hover:shadow-xl transition-shadow">
              <FaEnvelopeOpenText className="text-pink-600 text-2xl" />
              <span className="text-gray-700 font-medium">info@example.com</span>
            </div>
          </div>
        </div>
        ...
        <div className="w-full lg:w-2/4 mt-10 lg:mt-0">
          <form className="space-y-6">
            ...
            <div className="flex flex-col">
              <label htmlFor="message" className="text-gray-600 text-lg">Message</label>
              <textarea
                id="message"
                rows="6"
                className="border border-gray-300 rounded-lg p-4 focus:outline-none focus:ring-2 focus:ring-[#E63946] transition-colors"
      ...
      <div className="mt-16 px-4 lg:px-16">
        <div className="bg-gradient-to-r from-blue-100 to-purple-100 rounded-lg shadow-lg p-6 text-center">
          <h3 className="text-xl font-semibold text-gray-800">Our Location</h3>
          <p className="text-gray-600 mb-6">Visit us at our office for a friendly chat and personalized assistance.</p>
          {/* Map Placeholder */}
          <div className="w-full h-64 bg-gray-200 rounded-lg">
            <p className="text-gray-400 pt-24">[Map Placeholder]</p>
          </div>
        </div>
      </div>
    </div>
