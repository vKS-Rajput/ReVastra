...
const OurPolicy = () => {
  return (
    <div className="max-w-4xl mx-auto p-6 bg-white shadow-lg rounded-lg">
      <h1 className="text-3xl font-bold text-center text-blue-600 mb-6">ReVastra Return & Refund Policy</h1>
      ...
      <h2 className="text-2xl font-semibold text-blue-500 mt-6">Return Policies</h2>
      <ul className="list-decimal list-inside text-gray-700 space-y-2 mt-2">
        <li>Late Returns – ₹300 per day penalty, legal action after 7-10 days.</li>
        ...
        <li>Damaged product: Borrower must pay full amount, else legal action.</li>
        <li>Order Cancellations: Full refund if canceled by us; service charge applies if canceled at the doorstep.</li>
      </ul>
      
      <h1 className="text-3xl font-bold text-center text-blue-600 mt-8 mb-6">ReVastra Privacy Policy</h1>
      <h2 className="text-2xl font-semibold text-blue-500">Information We Collect</h2>
      ...
      <h2 className="text-2xl font-semibold text-blue-500 mt-6">Security & Third-Party Policies</h2>
      <ul className="list-disc list-inside text-gray-700 space-y-2 mt-2">
      ...
      <h1 className="text-3xl font-bold text-center text-blue-600 mt-8 mb-6">Contract & Delivery Process</h1>
      <ul className="list-disc list-inside text-gray-700 space-y-2">
        ...
        <li>Open Box Delivery: The product is checked at the time of delivery.</li>
